    ...
    <div class="bg-white p-6 rounded shadow mb-6">
      ...
      <form method="post" class="space-y-4">
        ...
        <div>
          ...
          <input type="text" name="name" value="<?=e($user['name'])?>" class="w-full border rounded px-3 py-2">
        </div>
        <div>
          <label class="block text-sm">Email (cannot change)</label>
          <input type="email" value="<?=e($user['email'])?>" disabled class="w-full border rounded px-3 py-2 bg-gray-100">
        </div>
        <div>
          <label class="block text-sm">Phone</label>
          <input type="text" name="phone" value="<?=e($user['phone'])?>" class="w-full border rounded px-3 py-2">
        </div>
        <div>
          <label class="block text-sm">Date of Birth</label>
          <input type="date" name="dob" value="<?=e($user['dob'])?>" class="w-full border rounded px-3 py-2">
        </div>
        <div>
        ...
        <div>
          ...
          <textarea name="address" class="w-full border rounded px-3 py-2"><?=e($user['address'])?></textarea>
        </div>
