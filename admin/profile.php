...
<head>
  <meta charset="utf-8">
  <title>Admin Profile - Healsync</title>
    ...
    <div class="mb-8">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-gray-600 mt-1">Manage your administrative account settings</p>
        </div>
    ...
    <div class="glass-effect rounded-2xl premium-shadow p-8 mb-8">
      <div class="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p class="text-gray-600 text-sm">Keep your administrative information current</p>
        </div>
      </div>
      <form method="post" class="space-y-6">
        ...
        <div class="relative">
          ...
          <textarea name="address" 
                    rows="3"
                    class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-white/80 backdrop-blur-sm resize-none"
        ...
        <div class="pt-4">
          <button type="submit"
                  class="w-full md:w-auto px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-medium flex items-center justify-center gap-2 hover:from-blue-700 hover:to-indigo-700 transform hover:scale-[1.02] transition-all duration-200 premium-shadow">
